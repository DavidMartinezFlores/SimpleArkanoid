...
def resetLocations(ball_x,ball_y,ball_radio,screen_height,stick_x,Point,ballx_Speed,bally_Speed):
    if(ball_y + ball_radio > screen_height+ball_radio+ball_radio ):
        ...
        ballx_Speed=randomMovementBallStartX()
...
def resetGame(ball_x,ball_y,ball_radio,lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset):
    lifes=3
    winnerValue=0
    ...
    return ball_x,ball_y,ball_radio,lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset
...
def isCollisionWithBlock(ball_radio,i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color):
    if (lifes>0 and winnerValue==0 and(arrayOfBlocks[i][0] < localizarPelota[0] < arrayOfBlocks[i][0] + block_width) and (arrayOfBlocks[i][1] < localizarPelota[1] < arrayOfBlocks[i][1] + block_height)):
        ...
        #Bloques especiales , pelota grande y pelota peque
        if(i==22):
            ball_radio=4#pelota peque
        if(i==27):
            ball_radio=28#èlota grande
        
    return ball_radio,i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color
...
ball_radio=10#radio de pelota 28 , super pelota , 4 mini pelota , 10 normal
...
while running:
    ...
    while i<len(arrayOfBlocks):
        ...
        ball_radio,i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color=isCollisionWithBlock(ball_radio,i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color)
    ...
    if keyPressed[pygame.K_u] and (lifes <=0 or winnerValue==1): # Reset Partida
        stick_x,stick_y,ball_x,ball_y,Point,ballx_Speed,bally_Speed=resetLocations(ball_x,ball_y,ball_radio,screen_height,stick_x,Point,ballx_Speed,bally_Speed)
        ball_x,ball_y,ball_radio,lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset=resetGame(ball_x,ball_y,ball_radio,lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset)
