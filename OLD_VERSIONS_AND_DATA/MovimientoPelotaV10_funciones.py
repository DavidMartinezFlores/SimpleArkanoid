...
def resetGame(lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset):
    lifes=3
    winnerValue=0
    ...
    return lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset
...
def isCollisionWithBlock(i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color):
    ...
    return i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color
...
while running:
    ...
    while i<len(arrayOfBlocks):
        ...
        i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color=isCollisionWithBlock(i,lifes,winnerValue,arrayOfBlocks,localizarPelota,block_width,block_height,ballx_Speed,ball_color)
    ...
    if keyPressed[pygame.K_u] and (lifes <=0 or winnerValue==1): # Reset Partida
        stick_x,stick_y,ball_x,ball_y,Point,ballx_Speed,bally_Speed=resetLocations(ball_x,ball_y,ball_radio,screen_height,stick_x,Point,ballx_Speed,bally_Speed)
        lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset=resetGame(lifes,winnerValue,arrayOfBlocks,arrayOfBlocksReset)
